...
let myStringPassword:any = '865Password!2020'; // However, if you don't specify a type, TypeScript will infer the type based on the value assigned to the variable.
...
let letNull: number |null = null;
let myNull = null;

let letUndefined: number |undefined = undefined;
