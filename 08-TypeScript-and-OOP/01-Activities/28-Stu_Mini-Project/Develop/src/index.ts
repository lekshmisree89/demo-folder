...
const starterEmployeeData: (ZooKeeper| ZooWorker)[] =[];

// Add the existing animals and employees
// TODO: The following default objects will not be 
//created. Update the related classes to make the objects generate
