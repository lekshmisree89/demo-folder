  ...
  return (
    <div className="container text-center">
      ...
      <div className="list-group">
        {/* TODO: Resolve the issue so that the welcomeStudent function properly alerts
          the name of the selected student when 
          the button is clicked. */}
        <button 
  //arrow function is used to pass the student since
  // the function is not being called immediately
