...
describe('Validate', () => {
  ...
  describe('Username Not Specified', () => {
    it('should throw exception for empty username', () => {
      const validate = new Validate();
      expect(() => { validate.isValidUsername(''); }).toThrow();
    });
  });
  ...
  describe('Username valid', () => {
    it('should return true for all lower case username at least 8 characters long', () => {
      const validate = new Validate();
      const result = validate.isValidUsername('lowercaseuserq');
      expect(result).toEqual(true);
    });
  });

  describe('Password Not Specified', () => {
    it('should throw exception for empty password', () => {
      const validate = new Validate();
      expect(() => { validate.isValidPassword(''); }).toThrow();
    });
  });
