...
const ProfileForm = () => {
  ...
  /*
    ...
    The useMutation hook returns an array. 
    //The function at index 0 can be dispatched within the component to
     trigger the mutation query
    The object at index 1 contains information, 
    such as the error boolean, which we use in this application
  */
  ...
  const handleFormSubmit = async (event: FormEvent) => {
    ...
    try {
      /*
        ! Important for useMutation:
        Here we want the mutation to occur in response to a form submission
