...
Postgres Shell is an advanced client and code editor 
for Postgres located right in our terminal. Let's open the Postgres Shell.
...
* We write our commands after the prompt. Don't forget, all
...
* We can also execute a file that contains 
a list of commands using `\i <FILENAME>`
