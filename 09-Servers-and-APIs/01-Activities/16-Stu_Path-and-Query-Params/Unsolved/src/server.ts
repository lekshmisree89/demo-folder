...
//get request to api/terms
// It checks if the query parameter 'sort' exists, 
//and sorts the terms in ascending or descending order accordingly.
// If no 'sort' query is provided, 
//it returns the original unsorted list of terms.

app.get('/api/terms/', (req: Request, res: Response) => {
  // TODO: Add a comment describing the req.query object
//any properties in req.query
...
// This route handles GET requests to '/api/term/:term'.
// It returns a specific term from the data based on the provided 'term' parameter.
// If the term does not exist, it returns a 'No term found' message.
app.get('/api/term/:term', (req: Request, res: Response) => {
  // TODO: Add a comment describing the content of req.params in this instance
 // req.params contains route parameters from the URL, e.g. /api/term/specificTerm
...
// TODO: Add a comment describing what this route will return
//It returns all terms that belong to the specified category.
...
// TODO: Add a comment describing what this route will return
// It returns a list of unique categories from the term data.
