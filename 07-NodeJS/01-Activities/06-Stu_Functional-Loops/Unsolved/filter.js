...
//filter method will create a new array by executing
// the condition for the prime number , with truthy values.

const primeArray = originalArray.filter(isPrime);
console.log(primeArray);

// TODO: Describe how filter is working in this example. What will the value of
// moreThan5Array be?
//it will run the filte method in the array and rteurns a new array is the valude is more than 5
